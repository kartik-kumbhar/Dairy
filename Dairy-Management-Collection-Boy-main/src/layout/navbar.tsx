...
// Simple mapping from path → title/subtitle
...
const Navbar: React.FC = () => {
  ...
  const userName = "Admin"; // later: read from auth/appConfig
  const meta = getPageMeta(location.pathname);

  return (
    <header className="flex items-center justify-between border-b border-[#E9E2C8] bg-white px-6 py-3 shadow-sm">
      {/* Left: breadcrumb + title */}
      <div className="flex flex-col">
        <div className="flex items-center gap-2 text-xs text-[#5E503F]/60">
          <button
            type="button"
        ...
        <div className="mt-0.5 text-lg font-semibold text-[#5E503F]">
          {meta.title}
        </div>
      ...
      <div className="flex items-center gap-4">
        <div className="hidden items-center gap-2 rounded-full bg-[#F8F4E3] px-3 py-1 text-xs text-[#5E503F]/80 sm:flex">
        ...
        <button
          type="button"
          className="rounded-full p-2 text-[#5E503F]/70 hover:bg-[#F8F4E3] hover:text-[#5E503F]"
        >
          <BellIcon />
        </button>
        <button
        ...
        <div className="flex items-center gap-2 rounded-full border border-[#E9E2C8] bg-[#F8F4E3] px-3 py-1">
          ...
          <div className="hidden text-xs sm:block">
            <div className="font-semibold text-[#5E503F]">
              {userName}
            </div>
